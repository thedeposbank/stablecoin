...
# setvar mincapshare         50,0000,0000
...
# must_pass "Sell dbond to bank" transfer_to_sell $emitent $DBONDS "1.00 $bond_name"
# pause

# title "List DPS sale"
# must_pass "List DPS sale" listdpssale "5.00000000 DPS" "0.40 DUSD"
# pause
...
# must_pass "Buy DUSD for EOS again" transfer_eos $TEST_ACC $BANK_ACC "0.2000 EOS" "Buy DUSD"
# pause
...
# transfer_to_sell $emitent $DBONDS "1.00 $bond_name2"
# pause
...
must_pass "Retire dbond 1" transfer $BANK_ACC $DBONDS "90.00 DUSD" "retire $bond_name2"
pause
